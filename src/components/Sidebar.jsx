    ...
    return (
        <>
            <aside id="default-sidebar"
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span className="flex-1 ml-3 text-left whitespace-nowrap">Patients</span>
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span className="flex-1 ml-3 text-left whitespace-nowrap">Schedules</span>
                                <svg aria-hidden="true" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd"
                                          d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <li>
                            <a href="#"
                               className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Service Types</span>
                                <span
                      ...
                      6
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span className="flex-1 ml-3 text-left whitespace-nowrap">Queue</span>
                                <svg aria-hidden="true" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd"
                                          d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <li>
                            <a href="#"
                               className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                ...
                                <span className="ml-3">Queue Logs</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                ...
                <div
                    className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
                    <a href="#"
